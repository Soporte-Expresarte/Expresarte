        ...
        <div class="max-w-lg mx-auto sm:px-6 px-4 pb-12 bg-white shadow-md rounded-lg">
            ...
            <div
                ...
                <textarea name="descripcion" id="descripcion"
                          class="block mt-1 w-full ring-4 ring-indigo-300 p-2 border rounded-md shadow-sm" rows="12"
            ...
            <div class="mt-6 form-group">
                <label class="font-light text-sm text-gray-800" for="foto_portada">{{ __('Foto de Portada Actual') }}</label>
                <img class="rounded-md" src="{{asset($evento->foto_portada)}}">
            </div>

            <div class="mt-6 form-group">
                <label class="font-light text-sm text-gray-800" for="foto_evento">{{ __('Foto del Evento Actual') }}</label>
                <img class="rounded-md" src="{{asset($evento->foto_evento)}}">
            </div>
            ...
            <div
                ...
                <label class="font-light text-sm text-gray-800"
                       for="foto_portada">{{ __('* Subir Imagen Banner') }}</label>
            ...
            <div
                ...
                <label class="font-light text-sm text-gray-800"
                       for="foto_evento">{{ __('* Subir Imagen Principal') }}</label>
            ...
            <div class="mt-12 flex justify-center">
                ...
                <button
                    ...
                    <a href="{{route('admin-eventos')}}">{{ __('Cancelar') }}</a>
                </button>
            </div>
