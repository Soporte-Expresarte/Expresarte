                        ...
                        <div
                            ...
                            <div class="p-2 rounded-lg">
                                ...
                                <div class="font-bold px-2 pb-4 text-white">
                                    <div class="mt-4">
                                        Título: <span class="font-light">{{ $evento->titulo }}</span>
                                    </div>
                                    <div class="mt-2">
                                        Fecha Inicio: <span class="font-light">{{ $evento->fecha_evento }}</span>
                                    </div>

                                    <div class="mt-4 flex justify-center">
                                        <button wire:click="editar({{ $evento }})"
                                                class="bg-green-600 hover:bg-green-500 font-semibold px-5 py-3 text-white rounded-md transition duration-500">
                                            {{ __('Editar') }}
                                        </button>

                                        <div class="px-4"></div>
                                        <button wire:click="eliminar({{ $evento }})"
