        ...
        <div class="max-w-lg mx-auto sm:px-6 px-4 pb-12 bg-white shadow-md rounded-lg">
            ...
            <div
                ...
                <textarea name="bajada" id="bajada"
                          ...
                          wire:model="bajada" :value="old('bajada')"></textarea>
                @error('bajada')
                <div class="text-red-600">{{ $message }}</div> @enderror
            </div>
            ...
            <div
                ...
                <textarea name="cuerpo" id="cuerpo"
                          ...
                          wire:model="cuerpo" :value="old('cuerpo')"></textarea>
                @error('cuerpo')
                <div class="text-red-600">{{ $message }}</div> @enderror
            </div>
            ...
            <div class="mt-6 form-group">
                <label class="font-light text-sm text-gray-800" for="portada">{{ __('Imagen banner actual') }}</label>
                <img class="rounded-md" name="portada" id="portada" wire:model="portada"
                     src="{{ asset($this->portada) }}">
            </div>

            <div class="mt-6 form-group">
                <label class="font-light text-sm text-gray-800" for="imagen">{{ __('Imagen principal actual') }}</label>
                <img class="rounded-md mt-4" name="imagen" id="imagen" wire:model="imagen"
                     src="{{ asset($this->imagen) }}">
            </div>
