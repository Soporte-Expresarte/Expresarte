<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si es necesario, puedes cerrar las sesiones de todos tus otros navegadores en todos tus dispositivos. Algunas de tus sesiones recientes se muestran a continuación. Si sientes que tu cuenta está comprometida o en riesgo, deberías actualizar tu contraseña.') }}
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por favor ingresa tu contraseña para confirmar que deseas cerrar sesión de tus otros navegadores en todos tus dispositivos.') }}
