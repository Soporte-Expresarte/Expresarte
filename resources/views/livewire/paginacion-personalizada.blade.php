            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div class="mr-4">
                    <p class="text-sm text-gray-700 leading-5">
                        @if (isset($elemento))
                            <span>{!! __('Mostrando') !!} {{$elemento}}</span>
                                    ...
                                    <span wire:key="paginator-page{{ $page }}">
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page">
                                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-exp-naranja bg-white border border-gray-300 cursor-default leading-5">{{ $page }}</span>
                                            </span>
                                        @else
