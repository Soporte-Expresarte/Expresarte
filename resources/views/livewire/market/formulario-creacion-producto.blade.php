        ...
        <div class="max-w-lg mx-auto sm:px-6 px-4 pb-12 bg-white shadow-md rounded-lg">
            ...
            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-3">
                ...
                <div>
                    ...
                    <x-jet-input id="ancho" class="block mt-1 w-full" type="number" name="ancho" :value="old('ancho')"
                                 required
                                 wire:model="ancho"/>
            ...
            <div
                ...
                class="mt-4"
            >
                <x-jet-label for="imagenes" value="{{ __('* Imagenes') }}"/>
                <input id="imagenes" class="block mt-1 w-full" type="file" name="imagenes"
                       required wire:model="imagenes" multiple accept=".png,.jpg,.jpeg"/>
