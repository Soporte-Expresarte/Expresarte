        ...
        <div class="carousel-inner relative overflow-hidden max-w-full">
            ...
            <div class="carousel-item absolute opacity-0" style="height:60vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-center"
                     style="background-image: url({{ isset($plana_22->banner)? asset($plana_22->banner): asset('images/imagen-default.jpg') }}); background-repeat: no-repeat;">

                    @if($plana_22->titulo || $plana_22->descripcion)
                        <div
                            ...
                            <div class="grid md:grid-cols-2 grid-cols-1">
                                <div class="md:col-span-2 col-span-1">
                                    ...
                                    <div class="mt-2 md:text-xl text-sm">
                                        {{ $plana_22->descripcion }}
                                    </div>

                                    @if($plana_22->link)
                                        <div class="h-4"></div>
                                        <a href="{{ $plana_22->link }}" class="mt-6">
                                            <div
            ...
            <div class="carousel-item absolute opacity-0 bg-cover bg-center" style="height:60vh;">
                ...
                <div class="block h-full w-full mx-auto flex py-6 md:pt-0 md:items-center bg-cover bg-center"
                     style="background-image: url({{ isset($plana_23->banner)? asset($plana_23->banner): asset('images/imagen-default.jpg') }}); background-repeat: no-repeat;">

                    @if($plana_23->titulo || $plana_23->descripcion)
                        <div
                            class="py-4 bg-gray-800 bg-opacity-50 text-white my-auto max-w-3xl p-4 sm:mx-16 mx-4 my-4 rounded-md">
                            <div class="grid md:grid-cols-2 grid-cols-1">
                                <div class="md:col-span-2 col-span-1">
                                    ...
                                    <div class="mt-2 md:text-xl text-sm">
                                        {{ $plana_23->descripcion }}
                                    </div>

                                    @if($plana_23->link)
                                        <div class="h-4"></div>
                                        <a href="{{ $plana_23->link }}" class="mt-6">
                                            <div
                                                class="rounded-lg md:text-xl text-sm px-4 py-2 mx-auto hover:bg-purple-600 absolute bg-purple-700 transition duration-500 text-white font-semibold">
                                                Leer más
                                            </div>
            ...
            <div class="carousel-item absolute opacity-0 bg-cover bg-center" style="height:60vh;">
                ...
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-center"
                     style="background-image: url({{ isset($plana_24->banner)? asset($plana_24->banner): asset('images/imagen-default.jpg') }}); background-repeat: no-repeat;">

                    @if($plana_24->titulo || $plana_24->descripcion)
                        <div
                            class="py-4 bg-gray-800 bg-opacity-50 text-white my-auto max-w-3xl p-4 sm:mx-16 mx-4 my-4 rounded-md">
                            <div class="grid md:grid-cols-2 grid-cols-1">
                                <div class="md:col-span-2 col-span-1">
                                    ...
                                    <div class="mt-2 md:text-xl text-sm">
                                        {{ $plana_24->descripcion }}
                                    </div>

                                    @if($plana_24->link)
                                        <div class="h-4"></div>
                                        <a href="{{ $plana_24->link }}" class="mt-6">
                                            <div
                                                class="rounded-lg md:text-xl text-sm px-4 py-2 mx-auto hover:bg-purple-600 absolute bg-purple-700 transition duration-500 text-white font-semibold">
                                                Leer más
                                            </div>
