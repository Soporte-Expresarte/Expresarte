<div class="carousel relative bg-center container max-w-full mx-auto">
    ...
    @php
        $plana_7 = \App\Models\Carrusel::find(7);
        $plana_8 = \App\Models\Carrusel::find(8);
        $plana_9 = \App\Models\Carrusel::find(9);
    @endphp
    ...
    <!--Slide 1-->
        ...
        <div class="carousel-item absolute opacity-0" style="height:60vh;">
            <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-center"
                 style="background-image: url({{ isset($plana_7->banner)? asset($plana_7->banner): asset('images/imagen-default.jpg') }}); background-repeat: no-repeat;">

                @if($plana_7->titulo || $plana_7->descripcion)
                    <div
                        ...
                        <div class="grid md:grid-cols-2 grid-cols-1">
                            <div class="md:col-span-2 col-span-1">
                                ...
                                @if($plana_7->link)
                                    <div class="h-4"></div>
                                    <a href="{{ $plana_7->link }}" class="mt-6">
                                        <div
        ...
        <div class="carousel-item absolute opacity-0 bg-cover bg-center" style="height:60vh;">
            ...
            <div class="block h-full w-full mx-auto flex py-6 md:pt-0 md:items-center bg-cover bg-center"
                 style="background-image: url({{ isset($plana_8->banner)? asset($plana_8->banner): asset('images/imagen-default.jpg') }}); background-repeat: no-repeat;">

                @if($plana_8->titulo || $plana_8->descripcion)
                    <div
                        class="py-4 bg-gray-800 bg-opacity-50 text-white my-auto max-w-3xl p-4 sm:mx-16 mx-4 my-4 rounded-md">
                        <div class="grid md:grid-cols-2 grid-cols-1">
                            <div class="md:col-span-2 col-span-1">
                                ...
                                @if($plana_8->link)
                                    <div class="h-4"></div>
                                    <a href="{{ $plana_8->link }}" class="mt-6">
                                        <div
                                            class="rounded-lg md:text-xl text-sm px-4 py-2 mx-auto hover:bg-purple-600 absolute bg-purple-700 transition duration-500 text-white font-semibold">
                                            Leer más
                                        </div>
        ...
        <div class="carousel-item absolute opacity-0 bg-cover bg-center" style="height:60vh;">
            ...
            <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-center"
                 style="background-image: url({{ isset($plana_9->banner)? asset($plana_9->banner): asset('images/imagen-default.jpg') }}); background-repeat: no-repeat;">

                @if($plana_9->titulo || $plana_9->descripcion)
                    <div
                        class="py-4 bg-gray-800 bg-opacity-50 text-white my-auto max-w-3xl p-4 sm:mx-16 mx-4 my-4 rounded-md">
                        <div class="grid md:grid-cols-2 grid-cols-1">
                            <div class="md:col-span-2 col-span-1">
                                ...
                                @if($plana_9->link)
                                    <div class="h-4"></div>
                                    <a href="{{ $plana_9->link }}" class="mt-6">
                                        <div
                                            class="rounded-lg md:text-xl text-sm px-4 py-2 mx-auto hover:bg-purple-600 absolute bg-purple-700 transition duration-500 text-white font-semibold">
                                            Leer más
                                        </div>
