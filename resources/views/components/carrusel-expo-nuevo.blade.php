        ...
        <div class="carousel-inner relative overflow-hidden max-w-full">
            ...
            <div class="carousel-item absolute opacity-0" style="height:60vh;">
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-center"
                     style="background-image: url({{ isset($plana_10->banner)? asset($plana_10->banner): asset('images/imagen-default.jpg') }}); background-repeat: no-repeat;">

                    @if($plana_10->titulo != null || $plana_10->descripcion != null)
                        <div
                            ...
                            <div class="grid md:grid-cols-2 grid-cols-1">
                                <div class="md:col-span-2 col-span-1">
                                    ...
                                    <div class="mt-2 md:text-xl text-sm">
                                        {{ $plana_10->descripcion }}
                                    </div>

                                    @if($plana_10->link)
                                        <div class="h-4"></div>
                                        <a href="{{ $plana_10->link }}" class="mt-6">
                                            <div
            ...
            <div class="carousel-item absolute opacity-0 bg-cover bg-center" style="height:60vh;">
                ...
                <div class="block h-full w-full mx-auto flex py-6 md:pt-0 md:items-center bg-cover bg-center"
                     style="background-image: url({{ isset($plana_11->banner)? asset($plana_11->banner): asset('images/imagen-default.jpg') }}); background-repeat: no-repeat;">

                    @if($plana_11->titulo || $plana_11->descripcion)
                        <div
                            class="py-4 bg-gray-800 bg-opacity-50 text-white my-auto max-w-3xl p-4 sm:mx-16 mx-4 my-4 rounded-md">
                            <div class="grid md:grid-cols-2 grid-cols-1">
                                <div class="md:col-span-2 col-span-1">
                                    ...
                                    <div class="mt-2 md:text-xl text-sm">
                                        {{ $plana_11->descripcion }}
                                    </div>

                                    @if($plana_11->link)
                                        <div class="h-4"></div>
                                        <a href="{{ $plana_11->link }}" class="mt-6">
                                            <div
                                                class="rounded-lg md:text-xl text-sm px-4 py-2 mx-auto hover:bg-purple-600 absolute bg-purple-700 transition duration-500 text-white font-semibold">
                                                Leer más
                                            </div>
            ...
            <div class="carousel-item absolute opacity-0 bg-cover bg-center" style="height:60vh;">
                ...
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-center"
                     style="background-image: url({{ isset($plana_12->banner)? asset($plana_12->banner): asset('images/imagen-default.jpg') }}); background-repeat: no-repeat;">

                    @if($plana_12->titulo !=null || $plana_12->descripcion !=null)
                        <div
                            class="py-4 bg-gray-800 bg-opacity-50 text-white my-auto max-w-3xl p-4 sm:mx-16 mx-4 my-4 rounded-md">
                            <div class="grid md:grid-cols-2 grid-cols-1">
                                <div class="md:col-span-2 col-span-1">
                                    ...
                                    <div class="mt-2 md:text-xl text-sm">
                                        {{ $plana_12->descripcion }}
                                    </div>

                                    @if($plana_12->link)
                                        <div class="h-4"></div>
                                        <a href="{{ $plana_12->link }}" class="mt-6">
                                            <div
                                                class="rounded-lg md:text-xl text-sm px-4 py-2 mx-auto hover:bg-purple-600 absolute bg-purple-700 transition duration-500 text-white font-semibold">
                                                Leer más
                                            </div>
